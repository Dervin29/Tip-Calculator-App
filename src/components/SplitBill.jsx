  ...
  return (
    <form className='flex flex-col gap-4'>
      <div className='flex flex-col'>
        <label className=' text-sm sm:text-base font-bold text-neutral-dark-grayish-cyan' htmlFor="bill-amount">Bill</label>
      ...
      <label className='text-sm sm:text-base font-bold text-neutral-dark-grayish-cyan' htmlFor="tip-amount">Select Tip %</label>
      ...
      <div className="flex flex-col">
        <div className='flex items-center justify-between '>
          <label className=' text-sm sm:text-base font-bold text-neutral-dark-grayish-cyan' htmlFor="num-people">Number of People</label>
          {error && (
